...
Команда выведет текущие переменные окружения нашего shell с их значениями. Аналогичный вывод, только с разделением по строкам, даст вызов команд `printenv`, `env`.
